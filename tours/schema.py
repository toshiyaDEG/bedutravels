...
class ZonaType(DjangoObjectType):
    ...
    class Meta: #define el modelo que se va a asociar para el tipo de dato
...
class Mutaciones(graphene.ObjectType): #Esta clase ayuda a definir las operaciones disponibles en la consulta de la api
    crear_zona = CrearZona.Field() #esta es la variable que se usa en graph
